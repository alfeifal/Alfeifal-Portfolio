...
interface Overview {
  ...
  finance: { current: { income: number; expenses: number; net: number; savingsRate: number | null; byCategory: { name: string; total: number }[] }; previous: { income: number; expenses: number; net: number }; monthly: { month: string; income: number; expenses: number }[]; netWorth: number };
  training: { current: { sessions: number; sets: number; volume: number; minutes: number; weekly: { week: string; sessions: number; volume: number }[] }; previous: { sessions: number; volume: number; sets: number } };
