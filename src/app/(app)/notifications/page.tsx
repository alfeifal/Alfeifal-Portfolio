...
interface Settings { tasks: boolean; deadlines: boolean; events: boolean; study: boolean; training: boolean; goals: boolean; finance: boolean; market: boolean; eventLeadMinutes: number; deadlineLeadDays: number }
